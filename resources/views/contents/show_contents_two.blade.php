                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="{{-- panel-title --}}">Item: {{ $allContentsTwo->first()->item_name }} <br> Sub Item: {{ $allContentsTwo->first()->subitem_name }}</h3>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        @foreach($allContentsTwo as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{ URL::to('/edit-contents-two/'.$item->item_id.'/'.$item->subItem_id.'/'.$item->id) }}" class="btn btn-sm btn-info">Edit</a>
                                                                <a href="{{ URL::to('/delete-contents-two/'.$item->item_id.'/'.$item->subItem_id.'/'.$item->id) }}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                                            </td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
